const WeatherApp = class {
    ...
    getCurrentWeather(query) {
        ...
        req.addEventListener("load", () => {
            this.currentWeather = console.log(JSON.parse(req.responseText));
            this.drawWeather();
        });
        req.send();
    }
    ...
    createWeatherBlock(cityName, dateString, temperature, feelslikeTemperature, iconName, description) {
...
document.weatherApp = new WeatherApp("f8cdce7232b38fa3479a8fd3db56af33", "#weather-results-container");

document.querySelector("#checkButton").addEventListener("click", function() {
    const query = document.querySelector("#locationInput").value;
    document.querySelector("#weather-results-container").style.display = "block";
